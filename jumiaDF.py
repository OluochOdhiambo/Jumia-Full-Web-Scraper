...
def launchSpider(baseUrl, productPage):
    ...
    try:
        ...
        productBrand = bsObj.find("div", {"class": "-fs14 -pvxs"}).find("a").get_text()
        ...
        productTotalRatings = bsObj.find("a", {"class":"-plxs -fs14 _more"}).get_text()
        productReviewTag = bsObj.find("a", {"class": "-plxs -fs14 _more"})
        try:
...
################# START SCRIPT ####################
filePath = "/home/practitioner/Desktop/ChatBot/Datasets/jumiaProductTree.txt"
...
savePath = "/home/practitioner/Desktop/ChatBot/Datasets/laptops.csv"
